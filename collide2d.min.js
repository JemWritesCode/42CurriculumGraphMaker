...
console.log('### p5.collide ###'),
  ...
  (p5.prototype.collideDebug = function(i) {
    _collideDebug = i;
  }),
  ...
  (p5.prototype.collidePointLine = function(i, t, e, o, r, l, n) {
    var c = this.dist(i, t, e, o),
      p = this.dist(i, t, r, l),
      s = this.dist(e, o, r, l);
    return void 0 === n && (n = 0.1), c + p >= s - n && c + p <= s + n;
  }),
  (p5.prototype.collideLineCircle = function(i, t, e, o, r, l, n) {
    ...
    var s = i - e,
      ...
      f = t + h * (o - t);
    return (
      !!this.collidePointLine(y, f, i, t, e, o) &&
      (this._collideDebug && this.ellipse(y, f, 10, 10),
      (s = y - r),
      (d = f - l),
      this.sqrt(s * s + d * d) <= n / 2)
    );
  }),
    ...
    if (s >= 0 && s <= 1 && d >= 0 && d <= 1) {
      if (this._collideDebug || p)
        var u = i + s * (e - i),
          h = t + s * (o - t);
      return (
        this._collideDebug && this.ellipse(u, h, 10, 10), !p || { x: u, y: h }
      );
    }
    return !!p && { x: !1, y: !1 };
  }),
  (p5.prototype.collideLineRect = function(i, t, e, o, r, l, n, c, p) {
    ...
    return (
      p
        ? ((s = this.collideLineLine(i, t, e, o, r, l, r, l + c, !0)),
          (d = this.collideLineLine(i, t, e, o, r + n, l, r + n, l + c, !0)),
          (u = this.collideLineLine(i, t, e, o, r, l, r + n, l, !0)),
          (h = this.collideLineLine(i, t, e, o, r, l + c, r + n, l + c, !0)),
          (y = { left: s, right: d, top: u, bottom: h }))
        : ((s = this.collideLineLine(i, t, e, o, r, l, r, l + c)),
          (d = this.collideLineLine(i, t, e, o, r + n, l, r + n, l + c)),
          (u = this.collideLineLine(i, t, e, o, r, l, r + n, l)),
          (h = this.collideLineLine(i, t, e, o, r, l + c, r + n, l + c))),
      !!(s || d || u || h) && (!p || y)
    );
  }),
  (p5.prototype.collidePointPoly = function(i, t, e) {
    for (var o = !1, r = 0, l = 0; l < e.length; l++) {
      ...
      var n = e[l],
        c = e[r];
      ((n.y > t && c.y < t) || (n.y < t && c.y > t)) &&
        i < ((c.x - n.x) * (t - n.y)) / (c.y - n.y) + n.x &&
        (o = !o);
    }
    return o;
  }),
  ...
  (p5.prototype.collidePointTriangle = function(i, t, e, o, r, l, n, c) {
    ...
    return (
      this.abs((e - i) * (l - t) - (r - i) * (o - t)) +
        this.abs((r - i) * (c - t) - (n - i) * (l - t)) +
        this.abs((n - i) * (o - t) - (e - i) * (c - t)) ==
      p
    );
  }),
